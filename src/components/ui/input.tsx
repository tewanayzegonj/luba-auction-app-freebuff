...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        /* No transition on focus styles: the ring must confirm the tap
           INSTANTLY. An animated focus ring delays perceived response by
           its own duration - and typing is the app's highest-frequency
           interaction (motion-principles frequency gate: never animate). */
