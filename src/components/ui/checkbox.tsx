...
function Checkbox({
  ...
  return (      <CheckboxPrimitive.Root
        ...
        className={cn(
          ...
          // Invisible halo: the 16px visual stays honest, but the tappable
          // region extends to a 44px circle (the global min-height rule
          // would otherwise deform this to 16×44 on touch devices).
